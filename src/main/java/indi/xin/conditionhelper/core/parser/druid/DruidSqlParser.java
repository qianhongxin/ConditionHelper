...
public class DruidSqlParser implements SqlParser {
    ...
    public void parseSqlBlocks(String sql, List<UserContext.Condition> conditions) {
    ...
    public <T> String parseInteral(String sql, List<T> values, List<UserContext.Condition> conditions) {
...
//    }
    ...
    public <T> String parse(String sql, List<T> values, List<UserContext.Condition> conditions) {
        ...
        return parseInteral(sql, values, conditions);
    }
